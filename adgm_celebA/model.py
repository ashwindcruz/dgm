...
class VAE(chainer.Chain):
    def __init__(self, dim_in, dim_hidden, dim_latent, num_layers, temperature, num_zsamples=1):
        ...
        # batch normalization layers at the start of the encoder and start of the decoder, q(a|x)
        ...
        # batch normalization layers at the start of the encoder and start of the decoder, q(z|a,x)
